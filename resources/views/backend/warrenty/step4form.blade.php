 ...
 <div class="container">
        <div class="row">
            <div class="col-md-3 sidebar p-1">
                ...
                <a class=" active text-center text-danger" href="userdeatiles.html">End User Details</a>
            ...
            <div class=" col-md-9 content border border-secondary p-3 m-0" style="height:auto;">
                <form action="{{route('save.userDetailsForm')}}" method="post">
                    @csrf
                    
                    <div class="row">
                        <h5 class="text-center text-dark text-decoration-underline m-2">End User Details</h5>
                        <input type="hidden" id="customer_id" name="customer_id" >
                        <div class="col-md-6 mb-3">
                            <label  class="form-label">Phone Number:</label>
                            <input class="form-control" type="text" id="phone_number" name="phone" placeholder="Enter mobile no." required onkeyup="checkNumber()">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" id="post_code" name="post_code" placeholder="Post Code">
