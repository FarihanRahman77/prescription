 ...
 <div class="container">
        <div class="row">
            <div class=" col-md-12 content border border-secondary w-75 h-auto m-auto">
                <h3 class="text-center text-dark text-decoration-underline ">General and fault details</h3>
                    ...
                    <div class="col-md-6 row">
                        <p><b>End User Details</b></p>
                           <table  width="100%" class="table table-bordered   m-0 border border-secondary">
                                <tr>
                                    <td width="40%">Company Name:</td>
                                    <td width="60%">{{@$info->company_name}}<input type="hidden" id="customer_id" value="{{@$info->customer_id}}"></td>
                                </tr>
                                <tr>
                                    <td width="40%">Company Address:</td>
                                    <td width="60%">{{@$info->address}}</td>
                                </tr>
                                <tr>
                                    <td width="40%">Town:</td>
                                    <td width="60%">{{@$info->city}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="40%">Post Code/Zip:</td>
                                    <td width="60%">{{@$info->post_code}}</td>
                                </tr>
                                <tr>
                                    <td width="40%">Phone:</td>
                                    <td width="60%">{{@$info->phone}}</td>
                                </tr>
                ...
                <div class="row">
                        ...
                        <p><b>Machine Information</b></p>
                           <table  width="100%" class="table table-bordered   m-0 border border-secondary">
                                <tr>
                                    ...
                                    <td width="60%"><input class="form-control" id="claim_ref_no"><span class="text-danger" id="claim_ref_noError"></span></td>
                                ...
                                <tr>
                                    ...
                                    <td width="60%"><input type="number" class="form-control" id="run_hour"> <span class="text-danger" id="run_hourError"></span></td>
                                </tr>
                                <tr>
                                    <td width="40%">Operating Hours Last Service:</td>
                                    <td width="60%"><input type="number" class="form-control" id="operating_hours_last_service" value=""><span class="text-danger" id="operating_hours_last_serviceError"></span></td>
                                </tr>
                                <tr>
                                    <td width="40%">Serviced By:</td>
                                    <td width="60%">
                                        <input class="form-control" id="service_by" placeholder="Provider name">
                                ...
                                <tr>
                                    ...
                                    <td width="60%"><input type="date" class="form-control" id="failure_date"><span class="text-danger" id="failure_dateError"></span></td>
                                </tr>
                                <tr>
                                    <td width="40%">Date Work Done:</td>
                                    <td width="60%"><input type="date" class="form-control" id="work_done_date" ><span class="text-danger" id="work_done_dateError"></span></td>
                                </tr>
                        ...
                        <p><b>Fault Information</b></p>
                           <table  width="100%" class="table table-bordered   m-0 border border-secondary">
                                <tr>
                                    ...
                                    <td width="60%">
                                        <textarea class="form-control" id="defect_details">
                                        </textarea>
                                ...
                                <tr>
                                    ...
                                    <td width="60%">
                                        <textarea class="form-control" id="defect_issue" >
                                        </textarea>
                                ...
                                <tr>
                                    ...
                                    <td width="60%"><input  class="form-control" id="oil_consumption"><span class="text-danger" id="oil_consumptionError"></span></td>
                                </tr>
                                <tr>
                                    <td width="40%">Ambient Temperature:</td>
                                    <td width="60%">
                                        <input  class="form-control" id="ambient_temperature"><span class="text-danger" id="ambient_temperatureError"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="40%">Action Taken:</td>
                                    <td width="60%">
                                        <textarea type="text" class="form-control" id="action_taken"></textarea>
                    ...
                    <h3 class="text-center text-dark text-decoration-underline ">Parts and Labours</h3>
                    <div class="row">
...
<script>
    ...
    function addSession(){
        ...
        var qty =1;
         $.ajax({
                url:"{{route('product.add.to.session')}}",
                method: "GET",
                data: {
                    "part_id":part_id,
                    "qty":qty
        ...
        $.ajax({
                ...
                success: function (result) {
                  ...
                  window.location.href=("{{ route('allClaim') }}");
                    ...
                    //alert(JSON.stringify(response));
                    $('#claim_ref_noError').text(response.responseJSON.errors.claim_ref_no);
                    $('#run_hourError').text(response.responseJSON.errors.run_hour);
                    $('#operating_hours_last_serviceError').text(response.responseJSON.errors.operating_hours_last_service);
                    $('#service_byError').text(response.responseJSON.errors.service_by);
                    $('#comission_dateError').text(response.responseJSON.errors.comission_date);
                    $('#failure_dateError').text(response.responseJSON.errors.failure_date);
                    $('#work_done_dateError').text(response.responseJSON.errors.work_done_date);
                    $('#defect_detailsError').text(response.responseJSON.errors.defect_details);
                    $('#defect_issueError').text(response.responseJSON.errors.defect_issue);
                    $('#oil_consumptionError').text(response.responseJSON.errors.oil_consumption);
                    $('#ambient_temperatureError').text(response.responseJSON.errors.ambient_temperature);
                    $('#action_takenError').text(response.responseJSON.errors.action_taken);
